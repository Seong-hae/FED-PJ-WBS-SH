// 쇼핑뉴스 컴포넌트 사용 데이터 - news.js

const news_data = [
    {
        idx : "1",
        newsrc:"./images/news/news1.jpeg",
        newname: ` [스페셜 혜택]
        ^ S/S SEASON OFF
        `,
        newdate: `6.1(목) ~ 6.25(일)`,
        newstore: "백화점 전점",
    ...
    {
        idx : "4",
        newsrc:"./images/news/news4.jpeg",
        newname: ` [Knotted World]
        ^ NEW OPEN
        `,
        newdate: `3.31(금) ~ 12.31(일)`,
        newstore: "일부지점",
    ...
    {
        idx : "7",
        newsrc:"./images/news/news7.jpeg",
        newname: ` [파이어벨]
        ^ 과 함께하는
        시원한 HAPPY HOUR
        `,
        newdate: `6.1(목) ~ 6.30(금)`,
        newstore: "일부지점",
    ...
    {
        idx : "9",
        newsrc:"./images/news/news9.jpeg",
        newname: ` [New Open] 
        ^ 프리미엄 식료품 편집샵 고메 팬트리
        `,
        newdate: `6.15(목) ~ 6.30(금)`,
        newstore: "백화점",
